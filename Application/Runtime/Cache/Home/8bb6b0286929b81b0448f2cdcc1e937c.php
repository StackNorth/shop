		...
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="" method="POST">
					<dl>
						<dt>用户名</dt>
						<dd><input type="text" name="user_name" id="user_name" class="text" /></dd>
					</dl>
					<dl>
						<dt>密码</dt>
					...
					<dl>
						<dt>确认密码</dt>
						<dd><input type="password" name="repassword" id="repassword" class="text" /></dd>
					</dl>
					<dl>
						<dt>邮箱</dt>
					...
					<dl>
						<dt>&nbsp;</dt>
						<dd><input type="submit" value="立即注册" class="submit" onclick="return checkPassword()" /> <input type= "checkbox" checked="checked"/>阅读并同意<a href="" class="forget">服务协议</a></dd>
					</dl>
				</form>
