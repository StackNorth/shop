...
<div class="container-fluid text-center">
    <div style="min-height: 760px;">
        <img src="<?php echo (ADMIN_PUBLIC); ?>/images/success.png" class="img-responsive center-block" style="margin-top: 8%;margin-left: 30%">
        ...
        <div style="font-size: 20px;padding-top: 2%;color: rgb(178,178,178);margin-left: 40%">
