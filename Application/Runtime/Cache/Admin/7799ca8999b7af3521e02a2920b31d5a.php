                            ...
                            <div class="navbar-default">
                                <ul class="breadcrumb">
                                    ...
                                    <li style="float: right">
                                        <span class="divider"></span>
                                        <a href="/shop/index.php/Admin/Attribute/add">添加属性</a>
                                    </li> 
                                </ul>
                            </div>
              <!-- end -->
                                     ...
                                     <tbody>
                                      <?php if(is_array($attrs)): $i = 0; $__LIST__ = $attrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                          ...
                                          <td align="center" nowrap="true" valign="top">
                                            <a href="/shop/index.php/Admin/Attribute/edit/id/<?php echo ($vo["attr_id"]); ?>" title="编辑"><img src="<?php echo (ADMIN_PUBLIC); ?>/images/icon_edit.gif" border="0" height="16" width="16"></a>
                                            <a href="/shop/index.php/Admin/Attribute/delete/id/<?php echo ($vo["attr_id"]); ?>" onclick="javascript:return confirm('确定要删除吗?');" title="移除"><img src="<?php echo (ADMIN_PUBLIC); ?>/images/icon_drop.gif" border="0" height="16" width="16"></a>
                                          </td>
