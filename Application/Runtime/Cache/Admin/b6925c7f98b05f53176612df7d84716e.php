...
<body>
  <h1>
    ...
    <span class="action-span1"><a href="__MOUDLE__/Index/index">SHOP 管理中心 </a> </span><span id="search_id" class="action-span1"> - <?php if($addAdmin != NULL): ?>添加<?php endif; ?> 管理员信息</span>
