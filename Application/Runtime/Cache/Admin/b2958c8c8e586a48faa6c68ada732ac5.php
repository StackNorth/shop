...
<div class="container-fluid text-center">
    <div style="min-height: 760px;">
        <img src="<?php echo (ADMIN_PUBLIC); ?>/images/error.jpg" class="img-responsive center-block" style="margin-top: 8%;margin-left: 40%">
        <div style="margin-top: 2%;margin-left:40%">
            <span style="font-size: 24px;font-weight: bold;color: rgb(178,178,178);"> <?php echo($error); ?>！</span>
        </div>
        <div style="font-size: 20px;padding-top: 2%;padding-left: 40%;color: rgb(178,178,178);">
