...
<body>
  <h1>
    <span class="action-span"><a href="/shop/index.php/Admin/User/edit/admin_id/{

$admin[0].admin_id}">编辑个人信息</a></span>
    <span class="action-span1"><a href="__MOUDLE__/Index/index">SHOP 管理中心 </a> </span><span id="search_id" class="action-span1"> - 个人信息 </span>
        ...
        <table width="90%" id="general-table" align="center" style="display: table;">
         ...
         <tbody>
          <tr>
           ...
           <td><input type="text" name="admin_name" value="<?php echo ($admin[0]["admin_name"]); ?>" >
           </td>
         </tr> 
         <tr>
         ...
         <tr>
          ...
          <td><input type="text" name="email" value="<?php echo ($admin[0]["email"]); ?>" >
           </td>
          </tr>
           <tr>
