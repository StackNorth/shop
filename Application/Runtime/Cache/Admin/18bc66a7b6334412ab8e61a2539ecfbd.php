                                ...
                                <table class="table table-bordered table-hover">
                                  <tbody>
                                    ...
                                    <?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td align="right"><?php echo ($vo["address_id"]); ?></td>
                                        <td align="center"><?php echo ($vo["order_status"]); ?></td>
                                          <td><?php echo ($vo["postscripts"]); ?></td>
                                          <td><?php echo ($vo["pay"]); ?></td>
                                          <td><?php echo ($vo["order_time"]); ?></td>
                                          <td><?php echo ($vo["order_amount"]); ?></td>
                                          <td align="center">
                                            <a href="/shop/index.php/Admin/Order/edit/id/<?php echo ($vo["order_id"]); ?>" title="编辑">编辑</a> |
                                            <a href="/shop/index.php/Admin/Order/delete/id/<?php echo ($vo["order_id"]); ?>" onclick="javascript:return confirm('你确认要删除吗？')" title="移除">移除</a> 
                                          </td>
