		...
		<table cellpadding="3" cellspacing="1">
			<tbody>
				...
				<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td><input type="checkbox" name="goods_id" value="<?php echo ($vo["goods_id"]); ?>"><?php echo ($vo["goods_id"]); ?></td>
					...
					<td align="center">
						...
						<a href="/shop/index.php/Admin/Goods/delete/id/<?php echo ($vo["brand_id"]); ?>" onclick="javascript:return confirm('你确认要删除吗？')" title="删除"><img src="<?php echo (ADMIN_PUBLIC); ?>/images/icon_trash.gif" width="16" height="16" border="0"></a> 
